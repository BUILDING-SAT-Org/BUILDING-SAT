@section('title', 'Internal External Finishes')
...
@section('content')
    ...
    <style>
        ...
        .bsat-internalExternal-entry {
            width: 2010px;
        }

        .bsat-internalExternal-entry-lg {
            width: 2140px;
        }

        .bsat-internalExternal-mortar-entry {
            width: 2410px;
        }

        .bsat-internalExternal-mortar-entry-lg {
            width: 2530px;
        }

        .bsat-internalExternal-mortar-entry-xl {
            width: 2700px;
        }
        ...
        #accordionInternalExternalResultsTable {
            width: 1365px;
        }

        #internalExternalResultTable tr > th:not(:first-child), td:not(:first-child) {
            text-align: right;
        }
    </style>
    ...
    <div>
        <div class="col-md-6 bsat-main-phase-description">
            <h2>Internal And External Finishes</h2>
            This section can be utilized to enter all the internal and external finishes related materials including
            floor finishes, wall finishes, roof/ceiling finishes etc.
        </div>

        <div class="col-md-12">
            <div id="internalExternal">
                <div v-for="field in fields" v-bind:is="field.type" :key="field.id" :field="field">
                </div>
            </div>

            <!--  Results Accordion  -->
            <div class="accordion bsat-accordion" id="accordionInternalExternalResults">
                <div class="accordion-item bsat-accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseInternalExternalResults" aria-expanded="false"
                                aria-controls="collapseInternalExternalResults">
                            <div class="bsat-sub-phase-label">Results</div>
                        </button>
                    </h2>
                </div>
                <div id="collapseInternalExternalResults" class="accordion-collapse collapse"
                     aria-labelledby="accordionInternalExternalResults"
                     data-bs-parent="#accordionInternalExternalResults">
                    <div class="accordion-body" style="padding: 0rem 1.25rem;">
                        <div class="col-md-12">
                            <p class="bsat-result-description">
                                The global warming potential (kg CO2 – eq) related to Internal and external finishes
                                activities such as Floor finishes, Wall finishes, Roof and ceiling finishes and Mortar:
                                Internal and external finishes are displayed with respect to machinery, material,
                        ...
                        <div class="accordion bsat-accordion" id="accordionInternalExternalResultsTable">
                            <div class="accordion-item bsat-accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapseInternalExternalResultsTable" aria-expanded="false"
                                            aria-controls="collapseInternalExternalResultsTable">
                                        <div class="bsat-sub-phase-label">Table View</div>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapseInternalExternalResultsTable" class="accordion-collapse collapse"
                                 aria-labelledby="accordionInternalExternalResultsTable"
                                 data-bs-parent="#accordionInternalExternalResultsTable">
                                <div class="accordion-body">
                                    <div class="justify-content-center">
                                        <h3 class="text-center">Global Warming Potential of Internal And External
                                            Finishes Activities</h3>
                                        <table id="internalExternalResultTable" data-unique-id="id" class="table">
                                            <thead>
                                            <tr>
                        ...
                        <div class="accordion bsat-accordion" id="accordionInternalExternalResultsChart">
                            <div class="accordion-item bsat-accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapseInternalExternalResultsChart" aria-expanded="false"
                                            aria-controls="collapseInternalExternalResultsChart">
                                        <div class="bsat-sub-phase-label">Chart View</div>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapseInternalExternalResultsChart" class="accordion-collapse collapse"
                                 aria-labelledby="accordionInternalExternalResultsChart"
                                 data-bs-parent="#accordionInternalExternalResultsChart">
                                <div class="accordion-body">
                                    <div>
                                        <canvas id="internalExternalResultChart"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Internal External Template -->
    <template id="internalExternalSubPhase">
    ...
    <!-- End Internal External Template  -->

    <!-- Internal External Entry Template -->
    <template id="bsatInternalExternalEntry">
    ...
    <!-- End Internal External Entry Template  -->

    <!-- Internal External Mortar Entry Template -->
    <template id="bsatMortarInternalExternalEntry">
        <div class="bsat-entry" :id="field.id" style="">
            <div style="text-align: right">
                <i class="fa fa-window-close" style="color: red"
                   v-on:click="removeEntry(field.is_new,field.entry_id,field.sub_phase)"></i>
    ...
    <!-- End Internal External Mortar Entry Template  -->
    ...
    <script>
        ...
        let resources;
        let internalExternalChart;
        let internalExternalEntries;
        let internalExternal;

        (function () {
            const promise1 = axios.get("/api/resources/" + project_id + "/internal-and-external-finishes");
            const promise2 = axios.get("/api/internal-and-external-finishes-entries/" + project_id);

            Promise.all([promise1, promise2]).then(function (values) {
                resources = values[0].data;
                internalExternalEntries = values[1].data;
                logToConsole("resp", {
                    resources: resources,
                    internalExternalEntries: internalExternalEntries
        ...
        async function init() {
            initinternalExternal();
            internalExternalChart = await generateMainPhaseResult("internal-and-external-finishes", "internalExternalResultTable",
                "internalExternalResultChart", CHART_TITLES.internalExternalPhase, "internalAndExternalFinishes");
        }

        function initinternalExternal() {

            Vue.component('bsatInternalExternalEntry', {
                template: '#bsatInternalExternalEntry',
                props: ['field'],
                components: {
                ...
                data: function () {
                    ...
                    return {
                        vgfRef: "bsatInternalExternalEntry",
                        model: field.is_new ? new_model : field.model,
                        schema: {
                            fields: [{
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatInternalExternalEntry.material,
                                model: "material_id",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.material,
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatInternalExternalEntry.quantity,
                                model: "quantity",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.quantity,
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatInternalExternalEntry.serviceLife,
                                model: "service_life",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.serviceLife,
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatInternalExternalEntry.wastage,
                                model: "wastage",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.wastage,
                                styleClasses: 'vgf-input-fixed',
                                required: true,
                                min: 0,
                                max: 100,
                                ...
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatInternalExternalEntry.localResourceLocation,
                                model: "location_id",
                                styleClasses: 'bsat-tree-select bsat-label-margin-top',
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.localResourceLocation,
                                required: true,
                                validator: ["required"],
                                valueFormat: "object",
                                selectOptions: {
                                ...
                                type: "input",
                                inputType: "text",
                                label: BSAT_LABELS.bsatInternalExternalEntry.otherLocation,
                                model: "other_location",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.otherLocation,
                                styleClasses: 'vgf-input-fixed bsat-label-margin-top',
                                required: true,
                                ...
                                visible: function (model) {
                                    if (undefined != this.$options.parent.$el) {
                                        if (model && model.location_id === -1) {
                                            this.$options.parent.$el.classList.add("bsat-internalExternal-entry-lg");
                                        } else {
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatInternalExternalEntry.localDistance,
                                model: "local_distance",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.localDistance,
                                styleClasses: 'vgf-input-fixed bsat-label-margin-top',
                                required: true,
                                min: 0,
                                validator: ["number", "double", "required"],
                                ...
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatInternalExternalEntry.localTransport,
                                model: "local_transport_vehicle_id",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.localTransport,
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatInternalExternalEntry.overseasDistance,
                                model: "overseas_distance",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.overseasDistance,
                                styleClasses: 'vgf-input-fixed bsat-label-margin-top',
                                min: 0,
                                onChanged: function (model, newVal, oldVal) {
                                    this.$parent.$parent.$parent.$emit("calculate", this);
                                ...
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatInternalExternalEntry.overseasTransport,
                                model: "overseas_transport_vehicle_id",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.overseasTransport,
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatInternalExternalEntry.totalCo2e,
                                model: "total_co2e",
                                help: BSAT_TOOLTIPS.bsatInternalExternalEntry.totalCo2e,
                                styleClasses: 'vgf-input-fixed',
                                readonly: true
                            }]
                        },
                ...
                methods: {
                    ...
                    calculate() {
                        if (this.$refs.bsatInternalExternalEntry.validate()) {
                            ...
                            logToConsole("calculate: internal external finishes entry", {
            ...
            Vue.component('bsatMortarInternalExternalEntry', {
                template: '#bsatMortarInternalExternalEntry',
                props: ['field'],
                components: {
                    "vue-form-generator": VueFormGenerator.component
                },
                ...
                data: function () {
                    ...
                    return {
                        vgfRef: "bsatMortarInternalExternalEntry",
                        model: field.is_new ? new_model : field.model,
                        schema: {
                            fields: [{
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.material,
                                model: "mortar_id",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.material,
                                styleClasses: 'bsat-tree-select bsat-tree-select-lg',
                                required: true,
                                validator: function (value, field, model) {
                                    if (!value) {
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.area,
                                model: "area",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.area,
                                styleClasses: 'vgf-input-fixed',
                                required: true,
                                min: 0,
                                validator: ["number", "double", "required"],
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.thickness,
                                model: "thickness",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.thickness,
                                styleClasses: 'vgf-input-fixed',
                                required: true,
                                min: 0,
                                validator: ["number", "double", "required"],
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.serviceLife,
                                model: "service_life",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.serviceLife,
                                styleClasses: 'vgf-input-fixed bsat-label-margin-top',
                                required: true,
                                min: 0,
                                validator: ["number", "double", "required"],
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.wastage,
                                model: "wastage",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.wastage,
                                styleClasses: 'vgf-input-fixed',
                                required: true,
                                min: 0,
                                max: 100,
                                ...
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.sandResourceLocation,
                                model: "sand_resource_location_id",
                                styleClasses: 'bsat-tree-select bsat-label-margin-top',
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.sandResourceLocation,
                                required: true,
                                validator: ["required"],
                                valueFormat: "object",
                                selectOptions: {
                                ...
                                type: "input",
                                inputType: "text",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.otherSandResourceLocation,
                                model: "sand_resource_other_location",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.otherSandResourceLocation,
                                styleClasses: 'vgf-input-fixed bsat-label-margin-top',
                                required: true,
                                validator: ["validateText", "required"],
                                onChanged: function (model, newVal, oldVal, field) {
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.sandTransportDistance,
                                model: "sand_transport_distance",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.sandTransportDistance,
                                styleClasses: 'vgf-input-fixed bsat-label-margin-top',
                                required: true,
                                min: 0,
                                validator: ["number", "double", "required"],
                                ...
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.sandTransportVehicle,
                                model: "sand_transport_vehicle_id",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.sandTransportVehicle,
                                styleClasses: 'bsat-tree-select bsat-tree-select-md',
                                required: true,
                                validator: ["required"],
                                valueFormat: "object",
                                ...
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.cementResourceLocation,
                                model: "cement_resource_location_id",
                                styleClasses: 'bsat-tree-select bsat-label-margin-top',
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.cementResourceLocation,
                                required: true,
                                validator: ["required"],
                                valueFormat: "object",
                                selectOptions: {
                                ...
                                type: "input",
                                inputType: "text",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.otherCementResourceLocation,
                                model: "cement_resource_other_location",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.otherCementResourceLocation,
                                styleClasses: 'vgf-input-fixed bsat-label-margin-top',
                                required: true,
                                validator: ["validateText", "required"],
                                onChanged: function (model, newVal, oldVal, field) {
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.cementTransportDistance,
                                model: "cement_transport_distance",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.cementTransportDistance,
                                styleClasses: 'vgf-input-fixed bsat-label-margin-top',
                                required: true,
                                min: 0,
                                validator: ["number", "double", "required"],
                                ...
                                type: "treeSelect",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.cementTransportVehicle,
                                model: "cement_transport_vehicle_id",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.cementTransportVehicle,
                                styleClasses: 'bsat-tree-select bsat-tree-select-md bsat-tree-select-overseas',
                                required: true,
                                validator: ["required"],
                                valueFormat: "object",
                                ...
                                type: "input",
                                inputType: "number",
                                label: BSAT_LABELS.bsatMortarInternalExternalEntry.totalCo2e,
                                model: "total_co2e",
                                help: BSAT_TOOLTIPS.bsatMortarInternalExternalEntry.totalCo2e,
                                styleClasses: 'vgf-input-fixed',
                                readonly: true
                            }]
                        },
                ...
                methods: {
                    ...
                    calculate() {
                        if (this.$refs.bsatMortarInternalExternalEntry.validate()) {
                            ...
                            this.model.total_material_co2e = this.model.sand_co2e + this.model.cement_co2e;
                            this.model.total_transport_co2e = this.model.sand_transport_co2e + this.model.cement_transport_co2e;
                            ...
                            logToConsole("calculate: internalExternal mortar", {
                                subPhase: this.field.sub_phase,
                                volume: volume,
                                ...
                                formulas: {
                                    sand_bulking_quantity: "6 / 7 * mortar_volume * sand_bulking_factor " +
                                        "* wastage_cal * sand_bulking_density",
                                    sand_co2e: "sand_bulking_quantity * 1000 * 0.003",
                                    sand_transport_co2e: "total_sand_distance * sand_bulking_quantity * sand_transport_gwp",
            ...
            Vue.component('internalExternalSubPhase', {
                template: '#internalExternalSubPhase',
                props: ['field'],
                data: function () {
                    return {
                        cssClasses: "",
                ...
                methods: {
                    addEntry: function (subPhase) {
                        if (subPhase === "mortar_internal_and_external_finishes") {
                            this.cssClasses = "accordion-collapse bsat-internalExternal-mortar-entry show";
                            this.fields.push({
                                'type': "bsatMortarInternalExternalEntry",
                                'id': this.count++,
                                'sub_phase': subPhase,
                            ...
                            this.cssClasses = "accordion-collapse bsat-internalExternal-entry show";
                            this.fields.push({
                                'type': "bsatInternalExternalEntry",
                                'id': this.count++,
                                'sub_phase': subPhase,
                                'distances': resources.distances,
                                'materials': resources.materials,
                    ...
                    generateModels: function (models, subPhase) {
                        ...
                        if (subPhase === "mortar_internal_and_external_finishes") {
                            this.cssClasses = "accordion-collapse bsat-internalExternal-mortar-entry";
                            ...
                            this.cssClasses = "accordion-collapse bsat-internalExternal-entry";
                            models.forEach((model) => {
                                this.fields.push({
                                    'type': "bsatInternalExternalEntry",
                                    'id': this.count++,
                    ...
                    removeEntry: async function (id, is_new, entry_id, sub_phase, addEntryBtnId) {
                        ...
                        if (!is_new) {
                            axios.delete('/api/internal-and-external-finishes-entries/' + project_id + '/' + urlEncodeSlug(sub_phase) + '/' +
                                entry_id)
                                .then(async (response) => {
                                    logToConsole("removeEntry resp", response, LOG_TYPES.HTTP_REQUEST);
                                    await saveInternalExternalFinishes(false);
                                })
                                .catch(error => {
                        ...
                        for (let child of this.$children) {
                            if ((undefined != child.$refs.bsatInternalExternalEntry && !child.$refs.bsatInternalExternalEntry
                                .validate()) || (undefined != child.$refs.bsatMortarInternalExternalEntry &&
                                !child.$refs.bsatMortarInternalExternalEntry.validate())) {
            ...
            internalExternal = generateComponent('#internalExternal', internalExternalEntries);
                ...
                return new Vue({
                    ...
                    methods: {
                        generateModels: function (models) {
                            ...
                            let subPhaseList = ["floor_finishes", "wall_finishes", "roof_and_ceiling_finishes",
                                "mortar_internal_and_external_finishes"]

                            subPhaseList.forEach((subPhase) => {
                                let model = models[subPhase];
                                this.fields.push({
                                    'type': 'internalExternalSubPhase',
                                    'id': this.count,
                                    'model': model.entries,
            ...
            $("#btnSave").on("click", function () {
                let isValid = true;
                if (!validateEntries(internalExternal, "internal-and-external-finishes", "foundation")) {
                    isValid = false;
                }

                if (isValid) {
                    saveInternalExternalFinishes(true);
                } else {
        ...
        async function saveInternalExternalFinishes(regenerateEntries) {
            let internalExternal_data = internalExternal.getModals();

            await axios.post("/api/internal-and-external-finishes-entries/" + project_id, {"data": internalExternal_data})
                .then(response => {
                    logToConsole("save internal external finishes resp", response, LOG_TYPES.HTTP_REQUEST);

                    if (regenerateEntries) {
                        internalExternal.fields = [];
                        internalExternal.generateModels(response.data);
                        successToast('Project Saved!');
                    }

                }).then(() => {

                    axios.get("/api/results/" + project_id + "/internal-and-external-finishes/type/chart")
                        .then(response => {
                            logToConsole("chart result resp", response, LOG_TYPES.HTTP_REQUEST);
                            updateSubPhaseChartDataSet(internalExternalChart, response.data.chart, "internalAndExternalFinishes");
                        }).catch(error => {
                        errorToast('Result Generation Failed!');
                        logToConsole("chart result resp error", error, LOG_TYPES.ERROR);
                    });

                    refreshSubPhaseTableData("internalExternalResultTable", "internal-and-external-finishes");
                }).catch(error => {
                    errorToast('Failed To Save!');
                    logToConsole("save internal external finishes error", error, LOG_TYPES.ERROR);
                });
        }
