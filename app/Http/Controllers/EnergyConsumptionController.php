...
class EnergyConsumptionController extends Controller
{
    ...
    public function view(Request $request)
    {
        try {
            ...
            return view('pages.energyConsumption', ['project_id' => $userProject->id, 'project_life' =>
    ...
    public function index(Request $request)
    {
        ...
        $mainPhase = BsatMainPhase::where('slug', 'energy_consumption')->first();
    ...
    {
        $main_phase = BsatMainPhase::where('slug', 'energy_consumption')->first();
        $data = $request['data'];
